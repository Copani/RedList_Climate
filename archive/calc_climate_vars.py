...
for i in range(rows):
  ...
  if rmap.geometry.is_valid:  
    for var_code in var_codes:
      ...
      if var_code == 'MAT':
        MAT_1940_1970_window, geo_mask, cell_coefs = prep_for_gridcalc(bioclim_1940_1970[var_code], species_i)
      else:
      ...
      var_mean_window = prep_for_gridcalc(bioclim20y[var_code].mean('years'), species_i, window_only=True)
      ...
      var_comp_window = prep_for_gridcalc(bioclim_comp[var_code].mean('years'), species_i, window_only=True)
