...
for f, filename in enumerate(files):
    ...
    daily_max = T_year.resample(time='D').max().compute()
...
final_dataset.to_netcdf('/home/claussar/ClimateVariables/ERA5monthly/ERA5_2mtemp_1940-2022_mean_dailyminmax_' + dataset + '.nc')
